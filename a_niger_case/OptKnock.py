...
def main():
    ...
    # Load model
    # ----------------------
    model = cobra.io.read_sbml_model("iJB1325_ATCC1015.xml")

    # ----------------------
    # Anaerobic condition
    # ----------------------
    model.reactions.get_by_id("BOUNDARY_O2e").lower_bound = -100
    ...
    # ----------------------
    biomass_rxn = "GROWTH"
    target_rxn  = "BOUNDARY_OAe"
    glucose_rxn = "BOUNDARY_GLCe"
    ...
    out_file = "OptKnock_iJB1325_OAA.xlsx"
